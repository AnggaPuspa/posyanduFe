...
import { ArrowRight, Baby, Users, MapPin, Bell, TrendingUp } from "lucide-react";
    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <ParallaxBanner
        ...
        layers={[
          ...
          {
            speed: -10,
            children: <div className="absolute inset-0 bg-black/10" />,
          },
        ]}
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-16">
          ...
          <div className="relative flex justify-center mt-8">
            <Parallax speed={5} className="relative">
              ...
              <div 
                className="absolute left-1/2 -translate-x-1/2 z-20 w-[90vw] md:w-auto hidden md:block"
                style={{ top: '40%' }}
              >
                <div 
                  className="bg-white shadow-2xl w-full md:w-[680px] p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-[20px]"
                >
                  <div className="flex justify-center gap-3 md:gap-6 lg:gap-8 flex-wrap md:flex-nowrap">
                    {[
                      { 
                        icon: (
      ...
      <section className="relative z-10 bg-gradient-to-b from-teal-100 to-teal-50 py-16 -mt-32 pt-20">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="hidden md:flex relative flex-wrap justify-center items-start gap-0">
            <div className="w-64 bg-white rounded-2xl p-5 shadow-lg -rotate-3 translate-y-8 z-10">
            ...
            <div className="w-64 bg-emerald-50 rounded-2xl p-5 shadow-lg rotate-2 -translate-x-4 z-20">
              <div className="flex items-center gap-2 mb-3">
                <img 
            ...
            <div className="w-64 bg-amber-50 rounded-2xl p-5 shadow-lg -rotate-2 translate-y-12 z-30">
              <div className="flex items-center gap-2 mb-3">
                <img 
            ...
            <div className="w-64 bg-violet-100 rounded-2xl p-5 shadow-lg rotate-3 -translate-x-2 translate-y-4 z-40">
              <div className="flex items-center gap-2 mb-3">
                <img 
          ...
          <div className="md:hidden">
            ...
            >
              ...
              <SwiperSlide>
                <div className="bg-emerald-50 rounded-2xl p-5 shadow-lg">
                  <div className="flex items-center gap-2 mb-3">
                    <img 
                      src="https://api.dicebear.com/7.x/lorelei/svg?seed=Dewi&backgroundColor=d1fae5" 
                      alt="Dewi Kartika"
              ...
              <SwiperSlide>
                <div className="bg-amber-50 rounded-2xl p-5 shadow-lg">
                  <div className="flex items-center gap-2 mb-3">
                    <img 
                      src="https://api.dicebear.com/7.x/lorelei/svg?seed=Rina&backgroundColor=fef3c7" 
                      alt="Rina Wulandari"
              ...
              <SwiperSlide>
                <div className="bg-violet-100 rounded-2xl p-5 shadow-lg">
                  <div className="flex items-center gap-2 mb-3">
                    <img 
                      src="https://api.dicebear.com/7.x/lorelei/svg?seed=Ani&backgroundColor=ede9fe" 
                      alt="Ani Suryani"
